...
Visit <https://jekyllrb.com/docs/posts/> and/or <https://github.com/adam-p/markdown-here/wiki/Markdown-Cheatsheet> for markdown post syntax.

__

### Changing an email address in the contact form

You can change your receiving email address in `_includes/contact_form.html`. Change the email address inside `action`.

```
<form class="contact-form" action="garlandk@gmail.com" method="POST">
```

For additional information regarding the contact form, refer to <https://formspree.io>
